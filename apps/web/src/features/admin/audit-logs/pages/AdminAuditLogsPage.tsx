...
export function AdminAuditLogsPage() {
  ...
  return <div className="grid gap-5" dir="rtl">
    ...
    <div className="grid gap-3 sm:grid-cols-[auto_1fr] sm:items-center"><select className={`${selectClass} sm:w-36`} value={limit} onChange={e => { setLimit(Number(e.target.value)); setPage(1) }}><option value={10}>۱۰ ردیف</option><option value={20}>۲۰ ردیف</option><option value={50}>۵۰ ردیف</option><option value={100}>۱۰۰ ردیف</option></select><PaginationControls page={page} pageCount={logs.data?.meta.totalPages ?? 1} onPageChange={setPage} disabled={logs.isFetching} /></div>
