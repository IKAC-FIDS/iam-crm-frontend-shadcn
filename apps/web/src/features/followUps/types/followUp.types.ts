...
export interface FollowUpActivity {
 ...
 company?:{id:string;legalName:string;brandName?:string|null;logoObjectKey?:string|null}|null;
 person?:{id:string;fullName:string}|null; user?:{id:string;fullName:string;email?:string|null;avatarObjectKey?:string|null}|null;
}
