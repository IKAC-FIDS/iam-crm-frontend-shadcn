...
import type { TaskOption } from "../types/task.types"
...
export function TaskOptionSelect({
  ...
  options: TaskOption[]
  onChange: (option?: TaskOption) => void
  search: string
        ...
        {searchable ? (
          <div className="relative mb-2">
            ...
            <Input
              ...
              placeholder={text.placeholders.searchOptions}
