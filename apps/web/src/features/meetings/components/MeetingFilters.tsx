...
export function MeetingFilters({
  ...
  return (
    <div className="grid min-w-0 gap-3 rounded-[var(--app-radius-card)] border border-[var(--app-divider)] bg-[var(--app-surface)] p-3 shadow-[var(--app-shadow-card)] lg:grid-cols-[minmax(220px,1.4fr)_minmax(180px,1fr)_160px_160px]">
      ...
      >
        <option value="">{text.fields.status}</option>
      ...
      <div className="flex min-w-0 gap-2">
        ...
        >
          <option value="">{text.fields.mode}</option>
          ...
          <PopoverTrigger
            render={
              <Button
                ...
                aria-label={text.actions.filters}
              />
            }
          >
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <FilterField label={text.fields.opportunity}>
                <MeetingOptionSelect
                  ...
                  onChange={(option) => onChange({ opportunityId: option?.id })}
              ...
              <FilterField label={text.fields.organizer}>
                <MeetingOptionSelect
                  ...
                  onChange={(option) => onChange({ organizerId: option?.id })}
              ...
              <FilterField label={text.fields.assignedUser}>
                <MeetingOptionSelect
                  ...
                  onChange={(option) =>
                    onChange({ assignedUserId: option?.id })
                  }
              ...
              <FilterField label={text.fields.attendee}>
                <MeetingOptionSelect
                  ...
                  onChange={(option) =>
                    onChange({ attendeePersonId: option?.id })
                  }
