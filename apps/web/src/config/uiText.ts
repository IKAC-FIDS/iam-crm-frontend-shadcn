  ...
  companies: {
    ...
    form: {
      ...
      registryLookup: {
        ...
        success: "اطلاعات رسمی شرکت دریافت و در فرم ثبت شد.",
        cacheSuccess: "اطلاعات ذخیره‌شده شرکت از سامانه بازیابی و در فرم ثبت شد.",
        error: "استعلام اطلاعات شرکت انجام نشد.",
        invalidNationalId: "شناسه ملی شرکت باید ۱۱ رقم باشد.",
      },
      journey: {
        identity: "هویت شرکت",
