export const uiText = {
  ...
  opportunities: {
    hero: {
      badge: "فضای کار فروش",
      title: "فرصت‌های فروش",
      description: "فرصت‌ها را در تمام چرخه فروش، از کشف تا نتیجه نهایی، در یک فضای یکپارچه مدیریت کنید.",
    },
    ...
    priorities: { LOW: "کم", MEDIUM: "متوسط", HIGH: "زیاد", STRATEGIC: "راهبردی" },
    fields: {
      title: "عنوان فرصت",
      company: "شرکت",
      primaryContact: "مخاطب اصلی",
    ...
    form: {
      ...
      editDescription: "اطلاعات فرصت را بدون تغییر مسئول یا مرحله به‌روزرسانی کنید.",
      ...
      sourcesError: "دریافت منابع فرصت انجام نشد؛ این فیلد فعلاً در دسترس نیست.",
      peopleError: "دریافت مخاطبان این شرکت انجام نشد.",
      ownersError: "فهرست مسئولان در دسترس نیست. می‌توانید از مسئول پیش‌فرض استفاده کنید.",
    ...
    dialogs: {
      ...
      terminalDescription: "این انتقال نتیجه مهمی در چرخه فروش ثبت می‌کند. در صورت نیاز یادداشت اضافه کنید.",
      archiveTitle: "بایگانی فرصت",
      archiveDescription: "فرصت از نماهای فعال کنار گذاشته می‌شود و بعداً قابل بازیابی است.",
    ...
    empty: {
      ...
      stagesDescription: "پیکربندی مراحل پایپ‌لاین برای نمایش این فضا لازم است.",
    },
    errors: {
      permissionTitle: "دسترسی مشاهده فرصت‌ها فعال نیست",
      permissionDescription: "برای استفاده از فضای فرصت‌ها به مجوز opportunity:view نیاز دارید.",
      ...
      ownerOptionsPermission: "فهرست مسئولان به دلیل محدودیت دسترسی در دسترس نیست.",
    },
    feedback: {
